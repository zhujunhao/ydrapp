...
class WebviewDeatil extends Component {
    constructor(props) {
        super(props);
        ...
        this.url = goods_URL + projectModel.commodity_id;
        const title = projectModel.commodityTitle;
        this.state = {
            title: title,
            url: this.url,
            canGoBack: false
    ...
    render() {
        ...
        const titleLayoutStyle = this.state.title? {paddingRight: 30} : null;
